    ...
    <main className="min-h-screen bg-neutral-50 pb-nav-safe">
      ...
      <div className="max-w-lg mx-auto px-4 mt-6">
        ...
        <div className="mb-6 bg-white rounded-card shadow-card border border-neutral-100 p-4 space-y-3">
          ...
          <div className="h-10 w-full rounded-pill bg-neutral-100 flex items-center justify-center gap-2 text-neutral-500 font-semibold text-sm">
            <Search size={15} />
            Cek Pesanan
          </div>
        </div>
